...
train_d = []
train_d += extractData("./ai/train", True)
train_d += extractData("./bA/train", True)
train_d += extractData("./dA/train", True)
train_d += extractData("./lA/train", True)
train_d += extractData("./tA/train", True)
...
S = 5
A = ["./ai/train", "./bA/train", "./dA/train", "./lA/train", "./tA/train"]
B = ["./ai/dev", "./bA/dev", "./dA/dev", "./lA/dev", "./tA/dev"]
...
def get(K):
    ...
    for i in range(5):
         ...
         for fn in os.listdir(r):             
             ...
             line = line.split()
             num_cordinates = int(line[0])
             for iii in range(1,num_cordinates,2):
                 s = str(lab[ind]) + " "
                 ind = ind + 1
                 f1.write(s)
             f1.write("\n")
