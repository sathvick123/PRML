...
for k in range(3):
  ...
  x = np.linspace(-sigma_1+mean_1-3, sigma_1+mean_1+3, num=100)
  y = np.linspace(-sigma_2+mean_2-3, sigma_2+mean_2+3, num=100)
  X, Y = np.meshgrid(x,y)
...
for k in range(3):
  ...
  x = np.linspace(-sigma_1+mean_1-16, sigma_1+mean_1+16, num=100)
  y = np.linspace(-sigma_2+mean_2-16, sigma_2+mean_2+16, num=100)
  X, Y = np.meshgrid(x,y)
  pdf = np.zeros(X.shape)
  for i in range(X.shape[0]):
    for j in range(X.shape[1]):
